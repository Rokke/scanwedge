...
class ScanwedgeChannel {
  ...
  Future<bool> createProfile({
    ...
    required String packageName,
      ...
      await _methodChannel.invokeMethod<bool>('createProfile', {
  ...
  Future<bool> toggleScanning() async =>
      await _methodChannel.invokeMethod<bool>('toggleScan') ?? false;

  Future<bool> sendCommand({
    required String command,
    required String parameter,
  }) async =>
      await _methodChannel.invokeMethod<bool>('sendCommand', {
        'command': command,
        'parameter': parameter,
      }) ??
      false;
  ...
  Future<bool> sendCommandBundle({
    ...
    required bool sendResult,
      ...
      await _methodChannel.invokeMethod<bool>('sendCommandBundle', {
        'command': command,
        'parameter': parameter,
