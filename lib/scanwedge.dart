...
class Scanwedge {
  ...
  // Future<String?> getPlatformVersion() => ScanwedgeChannel.instance.getPlatformVersion();
  // Future<bool> sendCommand(ScanProfile profile) =>ScanwedgePlatform.instance.sendCommand(command: profile.command, parameter: profile.parameter);

  Future<bool> createProfile(ScanProfile profile) => profile.sendCommands(ScanwedgeChannel.instance);
